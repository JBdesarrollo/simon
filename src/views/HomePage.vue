...
const doSound:Audio = new Audio(doAudio);
const faSound:Audio = new Audio(faAudio);
const reSound:Audio = new Audio(reAudio);
const solSound:Audio = new Audio(solAudio);
const wrongSound:Audio = new Audio(wrongAudio);
